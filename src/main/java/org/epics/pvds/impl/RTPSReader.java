...
public class RTPSReader implements PeriodicTimerCallback, AutoCloseable
{
    ...
    /**
     * Remote (data source) writer GUID.
     */
    ...
    public RTPSReader(RTPSParticipant participant,
    		int readerId, GUID writerGUID,
    		int maxMessageSize, int messageQueueSize)
    {
    	this(participant, readerId, writerGUID, maxMessageSize, messageQueueSize,
     ...
     * @param writerGUID remote (data source) writer GUID.
    ...
    protected void addAckNackSubmessage(ByteBuffer buffer, SequenceNumberSet readerSNState)
    {
	    ...
	    // writerId
	    buffer.putInt(writerGUID.entityId.value);
